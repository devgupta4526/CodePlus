...
flowchart TD
    OOP((OOP))
    OOP --> Objects
    Objects --> Properties["Properties / State"]
    Objects --> Behavior["Behavior / Methods"]
    ...
    OOP --> Relationships
    Relationships --> ISA["IS-A"]
    Relationships --> HASA["HAS-A"]
    HASA --> Aggregation
    HASA --> Composition
```
...
```mermaid
flowchart TD
    Pillars((Four Pillars of OOP))
    Pillars --> Abstraction
    Abstraction --> A1["Hide internal implementation"]
    Abstraction --> A2["Expose only essential features"]
    Abstraction --> A3["Achieved via Interface & Abstract Class"]
    
    Pillars --> Encapsulation
    Encapsulation --> E1["Bundle data + methods in one class"]
    Encapsulation --> E2["Data hiding via access modifiers"]
    Encapsulation --> E3["Promotes loose coupling"]
    
    Pillars --> Inheritance
    Inheritance --> I1["Child inherits parent properties"]
    Inheritance --> I2["Code reusability"]
    Inheritance --> I3["IS-A relationship"]
    
    Pillars --> Polymorphism
    Polymorphism --> PL1["Same method, many forms"]
    Polymorphism --> PL2["Overloading - Compile time"]
    Polymorphism --> PL3["Overriding - Runtime"]
```
...
flowchart TD
    Pillars((OOP Pillars))
    Pillars --> Abstraction
    Abstraction --> A1["Hides implementation"]
    Abstraction --> A2["Exposes only essential"]
    Abstraction --> A3["Via Interface / Abstract Class"]
    Abstraction --> A4["Example: Car brake pedal"]
    
    Pillars --> Encapsulation
    Encapsulation --> E1["Bundles data + methods"]
    Encapsulation --> E2["Access modifiers control access"]
    Encapsulation --> E3["private fields + public methods"]
    Encapsulation --> E4["Example: Medicine capsule"]
    
    Pillars --> Inheritance
    Inheritance --> I1["Child gets parent members"]
    Inheritance --> I2["extends keyword"]
    Inheritance --> I3["IS-A relationship"]
    Inheritance --> I4["Code reusability"]
    Inheritance --> I5["Diamond problem via interface"]
    
    Pillars --> Polymorphism
    Polymorphism --> P1["Many forms, same method"]
    Polymorphism --> P2["Overloading = Compile-time"]
    Polymorphism --> P3["Overriding = Runtime"]
    Polymorphism --> P4["Dynamic dispatch"]
```
