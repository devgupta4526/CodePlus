...
function renderHookDom(s,acc,anim,t,z){
  ...
  content.appendChild(el('div',`font-size:${px(40,z)};font-weight:700;color:#F5F5F4;font-family:'Space Grotesk',sans-serif;line-height:1.25;text-shadow:0 0 80px ${acc}50;${as(anim,150,z)}`,escHtml(s.title||'')));
  if(s.subtitle){
    const sub=el('div',`font-size:${px(16,z)};color:${acc};font-family:'Space Grotesk',sans-serif;border-left:3px solid ${acc};padding-left:${px(12,z)};${as(anim,350,z)}`,escHtml(s.subtitle));
...
function renderProblemDom(s,acc,anim,t,z){
  ...
  c.appendChild(el('div',`font-size:${px(34,z)};font-weight:700;color:#F5F5F4;font-family:'Space Grotesk',sans-serif;text-align:center;${as(anim,0,z)}`,escHtml(s.title||'')));
  if(s.subtitle) c.appendChild(el('div',`font-size:${px(14,z)};color:${acc};font-family:'Space Grotesk',sans-serif;text-align:center;${as(anim,80,z)}`,escHtml(s.subtitle)));
  ...
  (s.bullets||[]).forEach((b,i)=>{
    ...
    const row=el('div',`padding:${px(10,z)} ${px(16,z)};border-radius:${px(8,z)};border:1px solid ${clr}50;background:${clr}10;font-size:${px(15,z)};color:#CFCFC8;font-family:'Inter',sans-serif;text-align:center`,'','bullet-item');
    row.dataset.idx=i; row.textContent=b;
    rows.appendChild(row);
  });
  c.appendChild(rows);
  if(s.callout){
    const cb=el('div',`margin-top:${px(8,z)};padding:${px(12,z)} ${px(20,z)};border-radius:${px(10,z)};border:1px dashed ${acc}50;background:${acc}0a;font-size:${px(14,z)};color:#8C8C85;font-style:italic;font-family:'Inter',sans-serif;text-align:center;max-width:${px(520,z)}`,'','bullet-item');
...
function renderPredictionDom(s,acc,anim,t,z){
  ...
  w.appendChild(el('div',`font-size:${px(12,z)};color:${acc};font-family:'Inter',sans-serif;letter-spacing:.1em;border:1px solid ${acc}50;border-radius:${px(20,z)};padding:${px(5,z)} ${px(14,z)};${as(anim,0,z)}`,'🔮 PREDICTION'));
  w.appendChild(el('div',`font-size:${px(28,z)};font-weight:700;color:#F5F5F4;text-align:center;font-family:'Space Grotesk',sans-serif;line-height:1.4;max-width:${px(700,z)};${as(anim,120,z)}`,escHtml(s.question||s.title||'')));
  if(s.answer){
    const ans=el('div',`margin-top:${px(10,z)};padding:${px(14,z)} ${px(22,z)};border-radius:${px(10,z)};border:1px solid #7cf8a050;background:#7cf8a012;font-size:${px(16,z)};color:#7cf8a0;font-family:'Inter',sans-serif;text-align:center`,'','bullet-item');
    ans.dataset.idx=0;
    ans.innerHTML='✅ '+escHtml(s.answer);
    w.appendChild(ans);
  } else {
    w.appendChild(el('div',`font-size:${px(11,z)};color:#3a3d52;font-family:'Inter',sans-serif`,'▸ Pause here — let students guess'));
  }
  t.appendChild(w);
}
...
function renderWrongAssumptionDom(s,acc,anim,t,z){
  ...
  const chain=(steps,clr,icon,label,delayBase)=>{
    ...
    colW.appendChild(el('div',`font-size:${px(11,z)};color:${clr};font-family:'Space Grotesk',sans-serif;margin-bottom:${px(6,z)};font-weight:700`,label));
    steps.forEach((st,i)=>{
      const row=el('div',`width:${px(170,z)};padding:${px(9,z)} ${px(12,z)};border-radius:${px(7,z)};border:1px solid ${clr}50;background:${clr}10;font-size:${px(12,z)};color:#CFCFC8;font-family:'Inter',sans-serif;text-align:center`,'','bullet-item');
...
function renderStoryDom(s,acc,anim,t,z){
  ...
  if(s.title) w.appendChild(el('div',`font-size:${px(13,z)};color:${acc};font-family:'Space Grotesk',sans-serif;letter-spacing:.08em;margin-bottom:${px(8,z)};${as(anim,0,z)}`,'📖 '+escHtml(s.title)));
  (s.bullets||[]).forEach((b,i)=>{
    const line=el('div',`font-size:${px(19,z)};color:#CFCFC8;font-family:'Inter',sans-serif;text-align:center;line-height:1.6`,'','bullet-item');
    line.dataset.idx=i; line.textContent=b;
    w.appendChild(line);
  });
  if(s.note){
    const map=el('div',`margin-top:${px(14,z)};padding:${px(12,z)} ${px(22,z)};border-radius:${px(10,z)};border:1px solid ${acc}50;background:${acc}10;font-size:${px(15,z)};color:${acc};font-weight:700;font-family:'Inter',sans-serif;text-align:center`,'','bullet-item');
...
function renderAnalogyDom(s,acc,anim,t,z){
  ...
  if(s.title) c.appendChild(el('div',`font-size:${px(26,z)};font-weight:700;color:#F5F5F4;font-family:'Space Grotesk',sans-serif;text-align:center;${as(anim,0,z)}`,escHtml(s.title)));
  ...
  const card=(icon,label,desc,clr,delay)=>{
    ...
    cd.appendChild(el('div',`font-size:${px(16,z)};font-weight:700;color:${clr};font-family:'Space Grotesk',sans-serif;text-align:center`,escHtml(label)));
    if(desc) cd.appendChild(el('div',`font-size:${px(11,z)};color:#8C8C85;font-family:'Inter',sans-serif;text-align:center`,escHtml(desc)));
    return cd;
  };
  ...
  c.appendChild(row);
  if(s.subtitle) c.appendChild(el('div',`font-size:${px(13,z)};color:#666662;font-family:'Space Grotesk',sans-serif;text-align:center;${as(anim,380,z)}`,escHtml(s.subtitle)));
  t.appendChild(c);
}
...
function renderJourneyDom(s,acc,anim,t,z){
  ...
  c.appendChild(el('div',`font-size:${px(28,z)};font-weight:700;color:#F5F5F4;font-family:'Space Grotesk',sans-serif;text-align:center;margin-bottom:${px(4,z)};${as(anim,0,z)}`,escHtml(s.title||'')));
  if(s.subtitle) c.appendChild(el('div',`font-size:${px(13,z)};color:${acc};font-family:'Space Grotesk',sans-serif;text-align:center;margin-bottom:${px(16,z)};${as(anim,60,z)}`,escHtml(s.subtitle)));
  ...
  steps.forEach((step,i)=>{
    ...
    lbl.style.cssText=`font-size:${px(10,z)};color:#8C8C85;font-family:'Inter',sans-serif;text-align:center;max-width:${nSz+16}px;line-height:1.3;font-weight:600;`;
...
function renderMysteryDom(s,acc,anim,t,z){
  ...
  (s.bullets||[]).forEach((b,i)=>{
    const chip=el('div',`padding:${px(8,z)} ${px(16,z)};border-radius:${px(20,z)};border:1px solid ${acc}50;background:${acc}10;font-size:${px(13,z)};color:#CFCFC8;font-family:'Inter',sans-serif`,'','bullet-item');
    chip.dataset.idx=i; chip.textContent=b;
    chips.appendChild(chip);
  });
  w.appendChild(chips);
  const q=el('div',`font-size:${px(40,z)};font-weight:700;color:${acc};font-family:'Inter',sans-serif;text-shadow:0 0 50px ${acc}50;margin-top:${px(10,z)}`,'','bullet-item');
...
function renderMythRealityDom(s,acc,anim,t,z){
  ...
  if(s.title) c.appendChild(el('div',`font-size:${px(24,z)};font-weight:700;color:#F5F5F4;font-family:'Space Grotesk',sans-serif;text-align:center;margin-bottom:${px(18,z)};${as(anim,0,z)}`,escHtml(s.title)));
  ...
  myth.appendChild(el('div',`font-size:${px(13,z)};font-weight:700;color:#f87c7c;font-family:'Inter',sans-serif`,'❌ MYTH'));
  myth.appendChild(el('div',`font-size:${px(18,z)};color:#F5F5F4;font-family:'Inter',sans-serif;line-height:1.5`,escHtml(s.myth||'')));
  ...
  reality.appendChild(el('div',`font-size:${px(13,z)};font-weight:700;color:#7cf8a0;font-family:'Inter',sans-serif;margin-bottom:${px(4,z)}`,'✅ REALITY'));
  (s.bullets||[]).forEach((b,i)=>{
    const row2=el('div',`display:flex;gap:${px(8,z)};align-items:flex-start;font-size:${px(13,z)};color:#CFCFC8;font-family:'Inter',sans-serif`,'','bullet-item');
...
function renderCommonMistakeDom(s,acc,anim,t,z){
  ...
  c.appendChild(el('div',`font-size:${px(28,z)};font-weight:700;color:#F5F5F4;font-family:'Space Grotesk',sans-serif;margin-bottom:${px(4,z)};${as(anim,0,z)}`,'⚠️ '+escHtml(s.title||'Common Mistakes')));
  if(s.subtitle) c.appendChild(el('div',`font-size:${px(13,z)};color:${acc};font-family:'Space Grotesk',sans-serif;margin-bottom:${px(18,z)};${as(anim,60,z)}`,escHtml(s.subtitle)));
  ...
  (s.bullets||[]).forEach((b,i)=>{
    ...
    row.appendChild(el('span',`font-size:${px(15,z)};color:#CFCFC8;font-family:'Inter',sans-serif`,escHtml(b)));
...
function renderChallengeDom(s,acc,anim,t,z){
  ...
  w.appendChild(el('div',`font-size:${px(13,z)};color:${acc};font-family:'Inter',sans-serif;letter-spacing:.1em;border:2px solid ${acc};border-radius:${px(20,z)};padding:${px(6,z)} ${px(16,z)};${as(anim,0,z)}`,'⏸ CHALLENGE — PAUSE THE LESSON'));
  w.appendChild(el('div',`font-size:${px(30,z)};font-weight:700;color:#F5F5F4;text-align:center;font-family:'Space Grotesk',sans-serif;line-height:1.4;max-width:${px(700,z)};${as(anim,150,z)}`,escHtml(s.question||s.title||'')));
  if(s.note) w.appendChild(el('div',`font-size:${px(13,z)};color:#666662;font-family:'Inter',sans-serif;text-align:center;${as(anim,300,z)}`,escHtml(s.note)));
  t.appendChild(w);
}
...
function renderQuizDom(s,acc,anim,t,z){
  ...
  c.appendChild(el('div',`font-size:${px(11,z)};color:${acc};font-family:'Space Grotesk',sans-serif;letter-spacing:.1em`,'❓ '+(s.title||'QUIZ').toUpperCase()));
  c.appendChild(el('div',`font-size:${px(22,z)};font-weight:700;color:#F5F5F4;font-family:'Space Grotesk',sans-serif;text-align:center;max-width:${px(640,z)};${as(anim,0,z)}`,escHtml(s.question||'')));
  const opts=el('div',`display:flex;flex-direction:column;gap:${px(8,z)};width:${px(460,z)}`);
  (s.options||[]).forEach((o,i)=>{
    const isCorrect=i===s.correctIndex;
    const row=el('div',`padding:${px(10,z)} ${px(16,z)};border-radius:${px(8,z)};border:1px solid ${isCorrect?'#7cf8a0':acc+'30'};background:${isCorrect?'#7cf8a012':acc+'08'};font-size:${px(14,z)};color:#CFCFC8;font-family:'Inter',sans-serif;display:flex;gap:${px(10,z)};align-items:center`);
  ...
  if(typeof s.correctIndex==='number'&&s.options&&s.options.length){
    const reveal=el('div',`padding:${px(8,z)} ${px(16,z)};border-radius:${px(7,z)};font-size:${px(13,z)};color:#7cf8a0;font-family:'Inter',sans-serif`,'','bullet-item');
...
function renderMemoryTrickDom(s,acc,anim,t,z){
  ...
  c.appendChild(el('div',`font-size:${px(26,z)};font-weight:700;color:#F5F5F4;font-family:'Space Grotesk',sans-serif;text-align:center;${as(anim,0,z)}`,'🧠 '+escHtml(s.title||'Memory Trick')));
  ...
  (s.bullets||[]).forEach((b,i)=>{
    ...
    row.dataset.idx=i;
    const circ=el('div',`width:${px(28,z)};height:${px(28,z)};border-radius:50%;border:2px solid ${acc};background:${acc}20;display:flex;align-items:center;justify-content:center;font-size:${px(13,z)};font-weight:700;color:${acc};font-family:'Inter',sans-serif;flex-shrink:0`,String(i+1));
    row.appendChild(circ);
    row.appendChild(el('span',`font-size:${px(14,z)};color:#CFCFC8;font-family:'Inter',sans-serif`,escHtml(parts.join('  →  '))));
    list.appendChild(row);
  });
  c.appendChild(list); t.appendChild(c);
}
...
function renderDidYouKnowDom(s,acc,anim,t,z){
  ...
  w.appendChild(el('div',`font-size:${px(13,z)};color:${acc};font-family:'Inter',sans-serif;letter-spacing:.1em;${as(anim,0,z)}`,(s.calloutIcon||'💡')+' DID YOU KNOW?'));
  w.appendChild(el('div',`font-size:${px(24,z)};font-weight:600;color:#F5F5F4;text-align:center;font-family:'Space Grotesk',sans-serif;line-height:1.5;max-width:${px(680,z)};${as(anim,150,z)}`,escHtml(s.fact||s.title||'')));
  t.appendChild(w);
}
...
function renderCharacterDom(s,acc,anim,t,z){
  ...
  c.appendChild(el('div',`font-size:${px(26,z)};font-weight:700;color:#F5F5F4;font-family:'Space Grotesk',sans-serif;text-align:center;margin-bottom:${px(4,z)};${as(anim,0,z)}`,escHtml(s.title||'')));
  if(s.subtitle) c.appendChild(el('div',`font-size:${px(13,z)};color:${acc};font-family:'Space Grotesk',sans-serif;text-align:center;margin-bottom:${px(20,z)};${as(anim,60,z)}`,escHtml(s.subtitle)));
  ...
  chars.forEach((ch,i)=>{
    ...
    card.appendChild(el('div',`font-size:${px(12,z)};color:#CFCFC8;font-family:'Space Grotesk',sans-serif`,escHtml(ch.label||'')));
...
function renderTransitionDom(s,acc,anim,t,z){
  ...
  if(s.bullets&&s.bullets.length){
    ...
    s.bullets.forEach(b=>recap.appendChild(el('span',`padding:${px(5,z)} ${px(12,z)};border-radius:${px(14,z)};border:1px solid ${acc}40;background:${acc}0a;font-size:${px(11,z)};color:#8C8C85;font-family:'Inter',sans-serif`,'✔ '+escHtml(b))));
    w.appendChild(recap);
  }
  if(s.subtitle) w.appendChild(el('div',`font-size:${px(16,z)};color:#8C8C85;font-family:'Space Grotesk',sans-serif;text-align:center;${as(anim,150,z)}`,escHtml(s.subtitle)));
  w.appendChild(el('div',`font-size:${px(22,z)};color:${acc}`,'↓'));
  w.appendChild(el('div',`font-size:${px(30,z)};font-weight:700;color:#F5F5F4;text-align:center;font-family:'Space Grotesk',sans-serif;text-shadow:0 0 60px ${acc}40;${as(anim,300,z)}`,escHtml(s.nextTopic||s.title||'')));
  t.appendChild(w);
}
...
function renderSummaryDom(s,acc,anim,t,z){
  const c=el('div',`position:absolute;inset:0;padding:${px(46,z)} ${px(60,z)};display:flex;flex-direction:column;align-items:center;justify-content:center;gap:${px(20,z)}`);
  c.appendChild(el('div',`font-size:${px(30,z)};font-weight:700;color:#F5F5F4;font-family:'Space Grotesk',sans-serif;text-align:center;${as(anim,0,z)}`,escHtml(s.title||'Today you learned')));
  ...
  (s.bullets||[]).forEach((b,i)=>{
    ...
    row.appendChild(el('span',`font-size:${px(14,z)};color:#CFCFC8;font-family:'Inter',sans-serif`,escHtml(b)));
